      ...
      <div class="container d-flex">
        ...
        <div class="card-body col-4 mx-3 mb-5 mt-5 dash">
          ...
          <div class="card p-2 border-0">
              ...
              <span class = "mb-3" style = "color: grey;">025-3-13080-6</span>

              <h6 class = "my-0" style = "color: lightgrey;">ACCOUNT NAME</h6>
              <span class = "mb-3" style = "color: grey;">Krit Kruaykitanon</span>

              <h6 class = "my-0" style = "color: lightgrey;">BANK</h6>
              <span class = "mb-3" style = "color: grey;">Kasikorn Thai</span>
          </div>
        </div>
      </div>
    </div>
