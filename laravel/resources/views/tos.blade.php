...
@section('title', 'Terms and Conditions - Even Die I am The Tutor')
...
<div class="d-flex flex-column">
  ...
  <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to EDITT.</li>
    ...
    <li><strong>Website</strong> refers to EDITT, accessible from http://se.tongplw.codes</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
  </ul>
  ...
  <ul>
          <li>By email: support@tongplw.codes</li>
          </ul>
</div>
@endsection
